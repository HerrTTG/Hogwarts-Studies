...
# 反序列就是将json字符串转化为python数据。方便对数据进行进一步的处理。

# 记得要用单引号 因为json里面的字符串都是双引号，所以外面要用单引号 或者三引号来区分
json_str = '''{"code": 200, "msg": "success", "datas": [{"goods_id": "g0001", "goods_name": "iPhone12", "goods_price": 6999, "is_use": true}, {"goods_id": "g0002", "goods_name": "iPhone13", "goods_price": 7999, "is_use": false}]}'''
