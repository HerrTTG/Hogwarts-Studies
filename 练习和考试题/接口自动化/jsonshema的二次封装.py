...
# My_jsonschema().generate_jsonschema({"test":123})
# print(My_jsonschema().jsonschema_valida({"test":"ad"},My_jsonschema().schema))

My_jsonschema.generate_jsonschema_file({"test": 123}, './jsonchema.json')
print(My_jsonschema.jsonschema_valida_file({"test": "asd"}, './jsonchema.json'))
