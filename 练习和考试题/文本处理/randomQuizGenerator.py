...
# The quiz datas. Keys are states and values are their capitals.
...
for quizNum in range(35):
    ...
    quizFile = open('.\\考试\\capitalsquiz%s.txt' % (quizNum + 1), 'w')
    answerKeyFile = open('.\\考试\\capitalsquiz_answers%s.txt' % (quizNum + 1), 'w')
