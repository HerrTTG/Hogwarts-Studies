...
@allure.step
def _step1(step_param1, step_param2=None):
    '''定义一个测试步骤'''
...
@allure.link('www.baidu.com', name="某个关联链接")
...
TEST_CASE_LINK = 'https://yiyan.baidu.com/'


@allure.testcase(TEST_CASE_LINK, "用例管理系统2")
@allure.title("Test case 2")
@pytest.mark.parametrize('param1', [True, False])
@pytest.mark.parametrize('param2', ['value 1', 'value 2'])
def test_parametrize_with_two_parameters(param1, param2):
    _step1(param1, param2)


# --allure-link-pattern=issue:https://www.baidu.com/s?wd={}
@allure.issue('bug', "bug系统")
@allure.title("Tese case 3")
@pytest.mark.parametrize('param2', ['pytest', 'unittest'])
@pytest.mark.parametrize('param1,param3', [[1, 2]])
def test_parameterize_with_uneven_value_sets(param1, param2, param3):
    _step1(param1, param3)
    _step2(param2)
